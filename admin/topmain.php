...
// It will also link you back to your index page. //
    ...
    echo "<td align=right><a href='../index.php'><img border=0 src='../dist/img/accenture-logo.png' height='100' width='200'></a></td>\n";
...
if ($date_link == "none") {
    ...
    echo "    <td colspan=2 scope=col align=right valign=middle><a href='$date_link' style='color:#fcfcff;font-family:Tahoma;font-size:10pt;
...
if (isset($_SESSION['valid_user'])) {
    ...
    echo "    <td align=left valign=middle style='color:#fcfcff;font-family:Tahoma;font-size:10pt;padding-left:8px;'>logged in as: $logged_in_user</td>\n";
...
echo "    <td align=right valign=middle width=10><a href='../login.php' style='color:#fcfcff;font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Administration&nbsp;&nbsp;</a></td>\n";
...
if ((isset($_SESSION['valid_user'])) || (isset($_SESSION['time_admin_valid_user'])) || (isset($_SESSION['valid_reports_user']))) {
    ...
    echo "    <td align=right valign=middle width=10><a href='../logout.php' style='color:#fcfcff;font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Logout&nbsp;&nbsp;</a></td></tr>\n";
}
echo "</table>\n";
?>
