...
if ($request == 'GET') {
  ...
  echo "<span>Miscellaneous</span>\n";
  echo "<i class='fa fa-angle-left pull-right'></i>\n";
  echo "</a>\n";
  echo "<ul class='treeview-menu'>\n";
  echo "<li><a href='sysedit.php'><i class='fa fa-circle-o'></i>Edit System Settings</a></li>\n";
  ...
  echo "</aside>\n";
    ...
    if (!is_writable($filename)) {
        if (PHP_OS != 'WIN32') {
            ...
            echo "            <table width=100% border=0 cellpadding=0 cellspacing=0>\n";
            echo "              <tr><td height=25 class=table_rows_red>Accentur config file, config.inc.php, <b><i>is not writable</i></b> by your webserver
                      user:&nbsp;";
            echo "<b>";
            ...
            echo "              <tr><td height=25 class=table_rows_red>To edit the System Settings within Accentur System, either change the permissions
            ...
            echo "            <table width=100% border=0 cellpadding=0 cellspacing=0>\n";
            echo "              <tr><td height=25 class=table_rows_red>The Accenture System config file, config.inc.php, <b><i>is not writable</i></b> by your webserver
                      user!</td></tr>\n";
            echo "              <tr><td height=25 class=table_rows_red>To edit the System Settings within Accenture System , either change the permissions
                      on config.inc.php for this user, or assign this file to another owner, preferably your webserver user.</td></tr>\n";
            echo "            </table></td></tr>\n";
            include '../footer.php';
            exit;
    ...
    echo "              <tr><td colspan=3 class=table_rows width=10% align=left style='padding-left:4px;'>Listed below are the
                      settings that have been chosen within config.inc.php, the config file for Accenture System . Edit as you see fit. Then
    ...
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>dbversion:</td>
                  ...
                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>This is the versioning number of
                      the current database for Accenture System .</td></tr>\n";
    ...
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Choose \"yes\" to restrict the
                      ip addresses that can connect to Accenture System . If \"yes\" is chosen, you MUST input the allowed networks in the
                      allowed_networks array below. Otherwise, choosing \"yes\" here and leaving allowed_networks blank will cause Accenture System
    ...
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>These are the networks or ip
                      addresses you wish to allow to connect to Accenture System . This will currently only work for ipv4 addresses, ipv6 may be supported
    ...
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Choose whether to include
                      in the reports the ip addresses of the systems that connect to sign-in/out into Accenture System  or not. This option
    ...
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>color1:</td>
                  ...
                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>When times are displayed
                      anywhere within Accenture System , they are displayed with these two alternating row colors. Default is \"<b>#EFEFEF</b>\".
                 </td></tr>\n";
    $row_count++;
    $row_color = ($row_count % 2) ? $color2 : $color1;
    ...
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>These are the display names
                      for the links chosen above, meaning these are the items that are actually displayed in Accenture System . The number of
    ...
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>refresh:</td>
                  ...
                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Sets the refresh rate (in
                      seconds) for the application. If Accenture System  is kept open, it will refresh this number of seconds to display the most current
...
/* This adds a prefix to the tablenames in the database. This can be helpful if you
   have an existing mysql database that you would like to use with Accenture System .
...
/* Choose "yes" to restrict the ip addresses that can connect to Accenture System . If
   ...
   blank will cause Accenture System  to reject everyone attempting to connect to it.
   Default is "no". */

$restrict_ips = "' . $post_restrict_ips . '";


/* Insert the networks or ip addresses you wish to allow to connect to Accenture System
...
/* Choose "yes" if you want to disable the Edit System Settings page within PHP
   ...
   config.inc.php file through the Accenture System  interface instead of editing
...
/* Choose the way dates are displayed. DO NOT EDIT THESE DATE VARIABLES MANUALLY UNLESS YOU
   ...
   page in the Administration section of Accenture System  (sysedit.php). $datefmt default is
...
/* Choose whether to include in the reports the ip addresses of the systems that connect to
   sign-in/out into Accenture System  or not. This option is useful for auditing purposes. The
