  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="http://localhost/advanced/frontend/web/index.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
<!-- Mail Box -->
        <li>
          <a href="http://localhost/advanced/frontend/web/index.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://localhost/advanced/frontend/web/index.php?r=telework"><i class="glyphicon glyphicon-time"></i>Demande Le Télétravail</a></li>
            <li><a href="pages/charts/morris.html"><i class="glyphicon glyphicon-user"></i>Statut de la demande</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="http://localhost/advanced/frontend/web/index.php"><i class="fa fa-dashboard"></i> Home</a></li>
